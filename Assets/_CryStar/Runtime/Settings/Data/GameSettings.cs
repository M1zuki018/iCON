...
using CryStar.Settings.Enums;
using UnityEngine;

namespace CryStar.Settings.Data
{
    /// <summary>
    /// プレイヤーのゲーム設定
    /// </summary>
    ...
    public class GameSettings : ScriptableObject
    {
        ...
        [Header("サウンド設定")] [SerializeField, Range(0, 1)]
        ...
        [Header("環境設定")] [SerializeField] private LanguageType _textLanguage = LanguageType.Japanese;
